...
def plot_constraints(x1, caloric_x2, protein_x2, budget_x2):
    ...
    # Budget constraint
    plt.plot(x1, budget_x2, label='Budget Constraint: 0.074x₁ + 0.774x₂ ≤ 20', color='blue')
...
def main():
    ...
    # Budget constraint: 0.074x1 + 0.774x2 <= 20 => x2 <= (20 - 0.074x1)/0.774
    ...
    constraints = [
        ...
        {'type': '<=', 'coefficients': [0.074, 0.774], 'constant': 20} # Budget
    ]
